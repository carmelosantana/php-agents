 ...
 * McpClient::redact() does, for every McpServer::$headers value and the session id (spec §2,
 * amendment 3, 2026-09-21). $data is kept as the server sent it and is not part of the
