 ...
 * the server's own `error.message`, so a server that echoes a configured header value (an
 * Authorization credential, say) or a session id back in its error text does put one in an
 * exception message. And McpProtocolException and McpTransportException take a free-form
